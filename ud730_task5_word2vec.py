...
print('Data size %d' % len(words)) #17005207
...
print('Most common words (+UNK)', count[:5]) #[['UNK', 418391], ('the', 1061396), ('of', 593677), ('and', 416629), ('one', 411764)]
print('Sample data', data[:10]) #['anarchism', 'originated', 'as', 'a', 'term', 'of', 'abuse', 'first']
